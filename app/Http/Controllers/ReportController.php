...
class ReportController extends Controller
{
    ...
    public function store(Request $request, string $groupId)
    {
        $validated = $request->validate([
            ...
            'administrative_compliance_percentage' => ['required', 'numeric'],
            'deposit_compliance_percentage' => ['required', 'numeric'],
            'attendance_percentage' => ['required', 'numeric'],
            'organization_final_score_percentage' => ['required', 'numeric'],
            ...
            'cash_participation_percentage' => ['required', 'numeric'],
            'savings_participation' => ['required', 'integer'],
            'savings_participation_percentage' => ['required', 'numeric'],
            'meeting_deposit_percentage' => ['required', 'numeric'],
    ...
    public function update(Request $request, string $groupId, string $id)
    {
        ...
        $validated = $request->validate([
            ...
            'member_growth_in_percentage' => ['nullable', 'numeric'],
            'member_growth_out' => ['nullable', 'integer'],
            'member_growth_out_percentage' => ['nullable', 'numeric'],
            'group_member_total' => ['nullable', 'integer'],
            'group_member_total_percentage' => ['nullable', 'numeric'],
            'administrative_compliance_percentage' => ['nullable', 'numeric'],
            'deposit_compliance_percentage' => ['nullable', 'numeric'],
            'attendance_percentage' => ['nullable', 'numeric'],
            'organization_final_score_percentage' => ['nullable', 'numeric'],
            ...
            'cash_participation_percentage' => ['nullable', 'numeric'],
            'savings_participation' => ['nullable', 'integer'],
            'savings_participation_percentage' => ['nullable', 'numeric'],
            'meeting_deposit_percentage' => ['nullable', 'numeric'],
